...
const Subscrib = () => {
    ...
    return (
        <div className=" max-w-2xl mx-auto bg-slate-300 text-center">
            ...
            <form onSubmit={handleSubscribe}>
                ...
                <input className="bg-red-600 text-white font-bold px-6 py-2 rounded-lg my-3" type="submit" value="Submit" name="" id="" />
            </form>
        </div>
    );
};
